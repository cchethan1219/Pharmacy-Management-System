...
public class SellMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(449, 0, 322, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(189, 129, 60, -1));
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 155, 300, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 195, -1, 570));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Medicine ID");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 135, 106, -1));
        getContentPane().add(txtUniqueId, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 161, 246, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Name");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 201, 96, -1));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 239, 246, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Company Name");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 279, 189, -1));
        getContentPane().add(txtCompanyName, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 328, 246, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Price Per Unit");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(983, 135, 145, -1));
        ...
        getContentPane().add(txtPricePerUnit, new org.netbeans.lib.awtextra.AbsoluteConstraints(983, 161, 253, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("No of units");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(983, 201, 166, -1));
        ...
        getContentPane().add(txtNoOfUnits, new org.netbeans.lib.awtextra.AbsoluteConstraints(983, 239, 247, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Total Price");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(983, 279, 187, -1));
        getContentPane().add(txtTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(983, 328, 247, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 407, 580, 277));
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1028, 362, 154, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText(" RS:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(844, 732, -1, -1));
        ...
        getContentPane().add(lblFinalTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(892, 732, 130, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 690, -1, -1));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/adminDashboardBackground.png"))); // NOI18N
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(-15, -42, 1500, 850));
    ...
    private void txtNoOfUnitsKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoOfUnitsKeyReleased
        ...
        if (!noOfUnits.equals("")) {
            ...
            if (!noOfUnits.matches(numberPattern)) {
                JOptionPane.showMessageDialog(null, "Number of Units feild is invalid");
            }
            ...
            if (checkStock == 1) {
                ...
                if (rowCount != 0) {
                    for (int i = 0; i < rowCount; i++) {
                        ...
                        if (value != null) {
                            try {
                                int cartItemId = Integer.parseInt(value.toString());
                                if (cartItemId == Integer.parseInt(uniqueId)) {
                                ...
                                /*ex.printStackTrace();*/ // Or handle it appropriately
                            }
                        }
                    }
                }
    ...
    private void cartTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartTableMouseClicked
        ...
        if (index != -1) {
            ...
            if (a == 0) {
                ...
                Object totalObj = model.getValueAt(index, 5);
                if (totalObj != null) { // Adding null check here
                    String total = totalObj.toString();
                    try {
                        finalTotalPrice -= Integer.parseInt(total);
                        lblFinalTotalPrice.setText(String.valueOf(finalTotalPrice));
                    } catch (NumberFormatException e) {
                        JOptionPane.showMessageDialog(null, e); // Or handle the parsing error appropriately
                    }
                } else {
                    // Handle the case where totalObj is null
                }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (finalTotalPrice != 0) {
            ...
            if (cartTable.getRowCount() != 0) {
                for (int i = 0; i < cartTable.getRowCount(); i++) {
                    try {
                        Connection con = ConnectionProvider.getCon();
                        Statement st = con.createStatement();
                        st.executeUpdate("UPDATE medicine SET quantity = quantity - " + (dtm.getValueAt(i, 0) != null ? Integer.parseInt(dtm.getValueAt(i, 0).toString()) : 0) + " WHERE uniqueId = " + (dtm.getValueAt(i, 0) != null ? Integer.parseInt(dtm.getValueAt(i, 0).toString()) : 0));
            ...
            try {
                ...
                for (int i = 0; i < cartTable.getRowCount(); i++) {
                    String a = String.valueOf(cartTable.getValueAt(i, 0)); // Add null check
                    String b = String.valueOf(cartTable.getValueAt(i, 1)); // Add null check
                    String c = String.valueOf(cartTable.getValueAt(i, 2)); // Add null check
                    String d = String.valueOf(cartTable.getValueAt(i, 3)); // Add null check
                    String e = String.valueOf(cartTable.getValueAt(i, 4)); // Add null check
                    String f = String.valueOf(cartTable.getValueAt(i, 5)); // Add null check

                    // Check for null values before adding to table
                    a = (a != null) ? a : "";
                    b = (b != null) ? b : "";
                    c = (c != null) ? c : "";
                    d = (d != null) ? d : "";
